...
export const SITE = {
  ...
  // 예전엔 경력 관련 문구가 상단/중간/하단 3곳에 흩어져 있었는데,
  // 여기 한 곳으로 모았습니다. TRUST/PRINCIPLES 카드에서는 경력 반복 언급을 뺐습니다.
  about: {
    eyebrow: "ABOUT",
    titleLine1: "외벽방수, 코킹 업체는 정말 많습니다. 하지만,",
    titleHighlight: "오래 유지되는 시공법을 이해하는 업체",
    titleLine2: "는 많지 않습니다.",
    description:
      "레노베이는 동종업계에서도 자문을 구하는 코킹·방수 전문업체입니다. 실리콘을 쏘고 바르는 단순 작업이 아니라 빗물누수의 원인과 소재의 특성, 건물 구조를 판단하고 전문성 있게 시공합니다.",
    statBoxes: [
      { label: "레노베이의\n현장 실무 경력", value: "14년+" },
      { label: "레노베이의\n누적 현장 완료", value: "3,000건+" },
      { label: "레노베이의\n작업블로그 운영", value: "10년차", sub: "2017년부터 기록 중" },
    ],
  },
  ...
  trust: {
    ...
    description: "레노베이는 실력과 신뢰, 두 가지 모두 갖춘 시공 파트너입니다.",
    cards: [
      {
        icon: "shield",
        title: "정확한 사진 진단",
        desc: "사진이나 통화로 먼저 상황을 파악해드립니다. 방문이 꼭 필요한 경우에만 별도 안내해드립니다.",
      },
      {
        icon: "check",
    ...
    cards: [
      {
        icon: "shield",
        title: "안전을 최우선으로",
        desc: "로프 접근 작업의 특성상 안전 장비와 절차를 철저히 지키며 작업합니다.",
      },
      {
        icon: "clipboard",
        title: "투명한 견적과 설명",
